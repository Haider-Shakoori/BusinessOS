    ...
    */
    ...
    'registry' => [
        ...
        'accounting' => [
            ...
            'navigation' => ['group' => 'business', 'order' => 7, 'route' => 'accounting.index'],
        ],
        'manufacturing' => [
            'key' => 'manufacturing',
            ...
            'navigation' => ['group' => 'business', 'order' => 8, 'route' => 'manufacturing.index'],
        ],
        'crm' => [
            'key' => 'crm',
            'label' => 'modules.crm',
            'icon' => 'contact-card',
            'permission' => 'crm.view',
            'navigation' => ['group' => 'business', 'order' => 9, 'route' => 'crm.index'],
        ],
        'reports' => [
            'key' => 'reports',
