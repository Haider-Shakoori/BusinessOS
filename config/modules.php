    ...
    */
    ...
    'registry' => [
        ...
        'inventory' => [
            ...
            'navigation' => ['group' => 'business', 'order' => 5, 'route' => 'inventory.index'],
        ],
        'purchasing' => [
            'key' => 'purchasing',
            ...
            'navigation' => ['group' => 'business', 'order' => 6, 'route' => 'purchasing.index'],
        ],
        'pos' => [
            'key' => 'pos',
            'label' => 'modules.pos',
            ...
            'permission' => 'pos.view',
            'navigation' => ['group' => 'business', 'order' => 7, 'route' => 'pos.index'],
        ],
        'accounting' => [
            'key' => 'accounting',
            ...
            'navigation' => ['group' => 'business', 'order' => 8, 'route' => 'accounting.index'],
        ],
        'manufacturing' => [
            'key' => 'manufacturing',
            'label' => 'modules.manufacturing',
            'icon' => 'factory',
            'permission' => 'manufacturing.view',
            'navigation' => ['group' => 'business', 'order' => 9, 'route' => 'manufacturing.index'],
        ],
        'crm' => [
            'key' => 'crm',
            'label' => 'modules.crm',
