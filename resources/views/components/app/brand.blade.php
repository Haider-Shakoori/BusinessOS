...
<div class="flex h-12 shrink-0 items-center border-b border-white/10 px-4" x-bind:class="collapsed ? 'justify-center px-2' : ''">
    <div class="flex min-w-0 items-center gap-2.5">
        ...
        <span class="truncate text-[16px] font-semibold tracking-[-0.025em] text-white" x-bind:class="collapsed ? 'sr-only' : ''">
